...
def genSamples(featurePath, dictPath, csvPath, opt):
	f = open(dictPath)
	words = f.readlines()
	f.close()
	samples = []
	...
	if opt == 'train':
		...
		writeTest(samples, csvPath)


if __name__ == '__main__':
	genSamples('/media/yy/10A4078410A40784/grad_proj/exp/camel_1.4.0/', '/media/yy/10A4078410A40784/grad_proj/exp/dicts/dict_camel_1.4.0', '/media/yy/10A4078410A40784/grad_proj/exp/dicts/camel_train_1.4.0.csv', 'train')